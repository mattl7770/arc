...
// ===========================================================================
// 46. The owner's three in the day payload (2026-09-23). The Eat tab now prints
...
// ===========================================================================
console.log('46. get_today_snapshot carries sodium, caffeine and fiber — payload only');
{
