...
**Status:** Round 3 shipped (acquisition + editing gaps). Barcode scanning (live, with OFF lookup), inline portion editing, and AI photo/describe estimation are all wired; the only remaining online paths are barcode-OFF and AI, both gated. Recipe builder + weekly macro charts are the next slice.
