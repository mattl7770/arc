...
- ✅ **Photo storage:** the keepsake-vs-log split above — **amended 2026-08-12**: compress food logs (shipped, 0033), and keep a compressed **working copy** of progress pics rather than a PhotoKit reference (shipped, 0036). iCloud Photos still owns the full-quality original of a progress pic; what changed is that ARC no longer relies on being able to reach it.
