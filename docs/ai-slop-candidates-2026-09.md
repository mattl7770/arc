...
**Status: a proposal list. Nothing here has been changed.** One item was re-set in this branch (the protocol adherence plate, §0) because the owner named it specifically; everything below §0 is untouched and waits for one pass of approvals.
