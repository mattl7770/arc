...
| C9 | ✅ Protocol **time selector** | Items carry `scheduled_time`; the editor needs a picker. | Built on the existing column; no migration. |
...
**Dead gaps from this batch: `0048` · `0049` · `0051` · `0052`** (joining 0005 · 0006 · 0010 · 0019 · 0022 · 0023 · 0040 · 0041). A8, B3, C1, C2, C5–C10, C14 and D2 needed no migration.
