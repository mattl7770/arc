...
- Tests: `db/log.test.mjs` §13–§21 (§19 bounded metadata, §20 the command field's filing at 09:00 and 13:00, §21 the receipt's once-only rule and the link's silent/confirm rule), `db/turn-context.test.mjs` ST, `db/coach-tools.test.mjs` §48, `db/health-mapping.test.mjs` §13(c), `db/screens-render.test.mjs` §29.
